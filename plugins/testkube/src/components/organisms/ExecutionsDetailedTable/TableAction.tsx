...
export const TableAction: React.FC<TableActionProps> = ({ name, reload }) => {
  ...
  const [openHistoryExecutions, setOpenHistoryExecutions] =
  ...
  return (
    <Fragment>
      ...
      >
        ...
        <MenuItem onClick={runTestWorkflow}>Run</MenuItem>
      </Menu>
      <Dialog
        fullScreen={false}
        maxWidth="xl"
